...
app = Flask(__name__)
model = joblib.load(r"C:\Users\Hanshu\Desktop\VS code\ML\Student_Marks_Predictions\student_mark_predictor.pkl")
...
def predict():
    ...
    return render_template('index.html', prediction_text='You will get [{}%] marks, when ypu do study [{}] hours per day' .format(output, int(features_value[0]))) 
